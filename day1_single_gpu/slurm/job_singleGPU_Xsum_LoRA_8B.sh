#!/bin/bash -e
#SBATCH --job-name=ft-llama3-8B-lora-1gpu_Xsum
...
HOST_OUTPUT_DIR="$MyWD/results/checkpoints_out/llama3_1_8B_lora_single_device"
HOST_LOGGING_DIR="$MyWD/results/logs/lora_finetune_8B_output"
