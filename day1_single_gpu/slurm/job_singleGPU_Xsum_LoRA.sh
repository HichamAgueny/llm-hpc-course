...
HOST_OUTPUT_DIR="$MyWD/results/checkpoints_out/llama3_2_1B_lora_single_device"
HOST_LOGGING_DIR="$MyWD/results/logs/lora_finetune_1B_output"
...
CONFIG_FILE="/workspace/configs/lora/llama3_2_1B_lora_single_device_XSum.yaml"
PYTHON_FILE="/workspace/recipes/single_device/lora_finetune_single_device.py"
OUTPUT_DIR="/workspace/results/checkpoints_out/llama3_2_1B_lora_single_device"
LOGGING_DIR="/workspace/results/lora_finetune_1B_output"
