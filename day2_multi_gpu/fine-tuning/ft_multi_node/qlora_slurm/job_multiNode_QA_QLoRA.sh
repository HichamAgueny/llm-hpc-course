#!/bin/bash -e
#SBATCH --job-name=ft-llama3-1B-qlora-8gpu
...
MyCurrentWD="${MyWD}/day2_multi_gpu/fine-tuning/ft_multi_node/qlora_slurm"
...
CONFIG_FILE="${MyWD}/configs/qlora/llama3_2_1B_qlora_multi_node_QA.yaml"
