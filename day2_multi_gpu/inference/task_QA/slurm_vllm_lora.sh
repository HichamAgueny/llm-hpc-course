...
export LORA_PATH=${LORA_PATH:-"${MyWD}/results/checkpoints_out/llama3_2_1B_lora_single_device/epoch_0"}
...
export MONITOR_LOG="$LOG_DIR/gpu_lora_utilization_${SLURM_JOB_ID}.csv"
