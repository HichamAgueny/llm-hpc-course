...
#SBATCH -t 00:15:00
#SBATCH -N 1
#SBATCH --ntasks-per-node=1      # Changed to 1: vLLM handles internal GPU distribution
#SBATCH --gpus=4                 # Allocates 4 GPUs to this single task
...
PROMPT_FILE=${PROMPT_FILE:-"${MyWD}/day2_multi_gpu/inference/task_QA/prompt_QA.json"}
