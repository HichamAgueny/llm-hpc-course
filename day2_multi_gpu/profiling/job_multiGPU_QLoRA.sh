#!/bin/bash -e
#SBATCH --job-name=profiling_ft-llama3-8B-qlora-4gpu
...
CONFIG_FILE="${MyWD}/configs/qlora/llama3_1_8B_qlora_multi_device_profiling.yaml"
PYTHON_FILE="${MyWD}/recipes/distributed/lora_finetune_distributed.py"

# Host-side directories for output/logging
OUTPUT_DIR="${MyWD}/results/profiles/llama3_1_8B_qlora_multi_device"
LOGGING_DIR="${MyWD}/results/profiles/logs/qlora_finetune_8B_output"
