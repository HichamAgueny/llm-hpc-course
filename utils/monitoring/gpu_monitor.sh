...
TOOLS_DIR="/cluster/projects/nn9997k/hicham/llm-hpc-course/utils/monitoring"
...
watch -n 1 "nvidia-smi --query-gpu=utilization.gpu,memory.used,temperature.gpu,power.draw --format=csv,noheader,nounits | awk -F', ' '{ printf \"%-19s %-18s %-19s %-16s\\n\", \\\$1\" %\", \\\$2\" MiB\", \\\$3\" C\", \\\$4\" W\" }'"
EOF
